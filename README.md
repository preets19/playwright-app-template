...
This opens the local dashboard. The dashboard discovers app automation repos under:
...
Pick the automation repo you want to work with, then use the dashboard buttons to run tests, open Playwright Test Runner UI, or open Recorder UI.
...
During the phased local split, double-click:
