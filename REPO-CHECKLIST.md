...
- Dashboard Home `Setup Automation` completes on a clean machine.
- `npm.cmd run validate` succeeds.
- `playwright-automation-dashboard\Start Automation Dashboard.cmd` opens the dashboard.
...
- `playwright-automation-dashboard\scripts\windows\stop-automation.cmd` stops local automation backend processes where allowed.
